 ...
 */
class getEventuserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EventuserRepository' shared autowired service.
     *
     * @return \App\Repository\EventuserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EventuserRepository.php';

        return $container->privates['App\\Repository\\EventuserRepository'] = new \App\Repository\EventuserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
