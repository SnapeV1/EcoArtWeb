...
class Groups extends \App\Entity\Groups implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Groups' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Groups' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Groups' . "\0" . 'size', '' . "\0" . 'App\\Entity\\Groups' . "\0" . 'logo'];
        }
    ...
    public function setGid($id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGid', [$id]);

        return parent::setGid($id);
    }
