 ...
 */
final class Version20231104231717 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE groups CHANGE nom nom VARCHAR(20) NOT NULL, CHANGE logo logo VARCHAR(500) NOT NULL, CHANGE id Gid INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON groups');
        $this->addSql('ALTER TABLE groups CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE logo logo VARCHAR(255) NOT NULL, CHANGE Gid id INT AUTO_INCREMENT NOT NULL');
